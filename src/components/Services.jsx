    ...
    <div className='grid gap-10 lg:grid-cols-2'>
        {
            Services.map(({id, image, title}) => (
                <div key={id} className='flex flex-col items-center justify-center p-5 shadow-lg dark:shadow-red-600 rounded-xl duration-300 ease-in-out hover:scale-110 transition-all duration-300 blur-sm hover:blur-none '>
